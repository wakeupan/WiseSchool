...
//                    
//                    if (screenHeight == 480) {
//                        CGSize downSize = CGSizeMake(wself.bounds.size.width, wself.bounds.size.height);
//                        
//                        tempImage = [image resizedImageWithContentMode:UIViewContentModeScaleAspectFill
//                                                                bounds:downSize
//                                                  interpolationQuality:kCGInterpolationHigh];
//                        wself.image = tempImage;
//                    }else{
//                        wself.image = image;
//                    }
                    wself.image = image;
